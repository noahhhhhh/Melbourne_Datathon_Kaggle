...
Transform3to1 <- function(dt){
    ...
    while(i <= 199){
        set.seed(i * 1000)
        i.consecutive <- sort(sample(43, 3))
        i.UNIT <- paste(str_pad(i.consecutive[1], 2, pad = "0"), str_pad(i.consecutive[2], 2, pad = "0"), str_pad(i.consecutive[3], 2, pad = "0"), sep = "_")
...
## 1.3 save it ###############
##############################
save(dt.3in1, file = "../Datathon_Full_Dataset/transformed_more_random_Data.RData")
...
dim(dt.3in1)
# [1] 1113198     133
save(dt.3in1, file = "../Datathon_Full_Dataset/transformed_more_union_Data.RData")
