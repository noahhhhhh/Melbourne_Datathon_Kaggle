...
####################
## LAST_IND_IN_AND_OUT_PAY
####################
medIND_IN_AND_OUT_PAY <- median(dt1.1$IND_IN_AND_OUT_PAY, na.rm = T)
dt1.1 <- dt1.1[order(EVENT_SEQ)]
dt1.1[, LAST_IND_IN_AND_OUT_PAY := shift(IND_IN_AND_OUT_PAY , fill = medIND_IN_AND_OUT_PAY, type = "lag"), by = ACCOUNT_ID]
...
dt1.1[, LAST_IND_IN_AND_OUT_PAY := as.factor(LAST_IND_IN_AND_OUT_PAY)]
